...
@OneToMany(mappedBy="categorie")//association bidirectionnel on utilise mappedBy,
// de l'autre coté(dans la classe Produit) il y a un champ qui s'appele  categorie
...
public Categorie(String nomCategories, String description, byte[] photo, String nomPhoto) {
	super();
	this.nomCategories = nomCategories;
	this.description = description;
	this.photo = photo;
