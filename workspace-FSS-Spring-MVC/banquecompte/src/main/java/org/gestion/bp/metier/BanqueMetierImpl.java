...
public class BanqueMetierImpl implements IBanqueMetier {
	...
	@Override
	public List<Operation> consulterOperation(String codeCpte,int position,int nboperation)
	{
		// TODO Auto-generated method stub
		return dao.consulterOperation(codeCpte, position, nboperation);
	}
	...
	@Override
	public Groupe consulterGroupe(Long codeGr) {
		// TODO Auto-generated method stub
		return dao.consulterGroupe(codeGr);
	}

	@Override
	public Employe consulterEmploye(Long codeEmp) {
		// TODO Auto-generated method stub
		return dao.consulterEmploye(codeEmp);
	}

	
	@Override
	public long getNbreOperation(String numCpte) {
		// TODO Auto-generated method stub
		return dao.getNbreOperation(numCpte);
	}
