...
<td>${op}</td><!-- appler par defaut la methode toString -->
...
<div>
<c:forEach begin="0" end="${banqueForm.nbrePages-1}" var="p">
...
<a href="chargerCompte?page=${p}&code=${banqueForm.code}">Page${p}</a></span>
