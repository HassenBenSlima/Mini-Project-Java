...
public class ClientForm {
	...
	private List<Client> listClientByName;
	...
	public List<Client> getListClientByName() {
		return listClientByName;
	}
	public void setListClientByName(List<Client> listClientByName) {
		this.listClientByName = listClientByName;
	}
