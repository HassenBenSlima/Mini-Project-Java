...
<!--Fin Menu-->
    ...
    <div class="headert_text_resize">
      ...
      <div class="clr"></div>
      <h2 class="bigtext"><span> Gestion <br>du Moulin d'Olive</span><br ></h2>
...
<div align="center" >
  ...
  <a href="<c:url value="/moulin/moulinClient/ALLnameClient"/>" class="list-group-item active ">Consulter client par nom</a>
...
<div align="center">
<f:form modelAttribute="emplo"  action="nameClRechercher" class="form-inline"  method="post"  >
<div class="form-group">
<label>Recherche par nom:</label>
<f:input path="nameClient" class="form-control" placeholder="Nom client"/>
<f:errors path="nameClient" cssClass="error"></f:errors>  
</div>
    <div class="form-group">
...
<th>Adrésse client</th><th>Téléphone client</th>
<th colspan="2">Action</th>
</tr>



<c:forEach items="${epff}" var="p" >
<tr>	
