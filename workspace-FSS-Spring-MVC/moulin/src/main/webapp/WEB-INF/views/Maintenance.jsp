...
<f:form modelAttribute="maint" action="saveMain" id="myForm"
...
<td><f:input path="dateMain" class="datepicker" size="25" id="date" placeholder="clic ici pour monter l'agenda"/></td>
</tr>
<tr>
<td></td>
...
<td><a href="<c:url value="/moulin/moulinFrns/indexfm"/>">Gérer les fournisseurs</a></td>
</tr>
<tr>
<td></td>
...
<td><f:textarea   path="descpanne" cols="70" class="form-control"  id="ds" placeholder="Description"/></td>
</tr>
<tr>
<td></td>
...
<input class="btn btn-primary" type="button" onclick="myFunction()" value="Ajouter">
...
function myFunction() {
	...
	if((date=="")||(dsgn=="")){
		...
		alert("Verifier les informations de cette maintenance!"); 
