...
<td><f:errors path="idBA" cssClass="danger"></f:errors></td>
 ...
 <tr> 
 <td>Solde:</td>
<td><f:select  path="caisse.idCaisse"  items="${css}" itemValue="idCaisse" itemLabel="solde" class="form-control"></f:select></td>
<td><f:errors path="caisse.idCaisse" cssClass="danger"/></td>
</tr>
...
<tr>
<td>Date d'achat :</td>
<td><f:input path="dateBA" class="datepicker"  size="25" placeholder="clic ici pour monter l'agenda"/></td>
...
<td><input type="text" name="frnname" id="frnname" disabled class="form-control"/>
</td>
</tr>
<tr><td><br></td></tr>
...
<td><a href="<c:url value="/moulin/moulinFrns/indexfo"/>">Gérer les fournisseurs</a></td>
...
<f:option value="Olives à couleur tournée">Olives à couleur tournée</f:option>
...
<tr>
<td>Quantité olive:</td>
<td><f:input   path="quantiteOL"  class="form-control" placeholder="quantité d'olive"/></td>
...
<tr>
<td>Designation:</td>
<td><f:textarea   path="designation" placeholder="designation" class="form-control"/></td>
...
<tr>
<td>Region olive:</td>
<td><f:input   path="regionOlive"  class="form-control" placeholder="region d'olive"/></td>
