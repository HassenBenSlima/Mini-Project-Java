...
<div class="body"><div class="body_resize">
  ...
  <a href="<c:url value="/moulin/Caisse/acceuil"/>" class="list-group-item active">Accueil</a>
  <a href="<c:url value="/moulin/Caisse/indexcaisse"/>" class="list-group-item ">Gerer la caisse</a>
...
notre application a pour but de gerer les diferente tache du moulin d'olive </p>
