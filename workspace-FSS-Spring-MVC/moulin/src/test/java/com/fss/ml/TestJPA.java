...
//				List<Client> c=metier.listClient();
			    metier.ajouterClient(new Client(12345678L, "hassen","ben slima", "sakia", 20014411L));
			    metier.ajouterClient(new Client(14253610L, "atef","boujelben", "sakia", 20014411L));
...
//				List<Fournisseur> frn1=metier.listFournisseur();
			//	metier.ajouterFournisseur(new FournisseurOlive(12345678L, "Omar","Abida",74345678L, "route de mahdia klm 15"));
			//	metier.ajouterFournisseur(new FournisseurMaintenance(11223344L, "naser eddine","bouzidi",23123456L, "route tanyour klm 10"));
...
//              metier.ajouterStock(new CuveOlives("stock11",5221455,4000));
//              metier.ajouterStock(new CuveOlives("stock22",5221455,4000));
...
//					assertTrue(cv1.size()+2==cv2.size());
		...
		// metier.ajouterBA(new BonAchat(new Date(), 555, "bien", 150, "sfax", "Sfax"),1L,55L);
