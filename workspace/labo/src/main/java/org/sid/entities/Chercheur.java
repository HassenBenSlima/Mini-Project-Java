...
public class Chercheur implements Serializable {
	...
	//bi-directional one-to-one association to Laboratoire
	@OneToOne
	...
	public Chercheur(long numChercheur, String adresse, String email, String grade, String nom, BigDecimal numTel) {
		super();
		this.numChercheur = numChercheur;
		this.adresse = adresse;
		this.email = email;
