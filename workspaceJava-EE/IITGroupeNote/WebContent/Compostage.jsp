...
<section class="content-header">
	<h1>
		Affichage de Compostage 
		<small>Aperçu</small>
	</h1>
	<ol class="breadcrumb">
		<li><a href="#"><i class="fa fa-dashboard"></i> Accueil</a></li>
		<li class="active">Affichage de Compostage</li>
	</ol>
</section>
	...
	<div class="row">
		<div class="col-md-12">
              ...
              <div class="box">
                ...
                <center>
                <div>
                     <form class="form-inline" action="CompostageController" method="post">
...
<c:forEach items="${groupe.groupeenseignants}" var="gEns">
       ...
       <label> <i class="fa fa-file-text" aria-hidden="true"></i>&nbsp; ${gEns.matiere.libelle}</label>
         <button type="button" class="btn btn-default btn-xs pull-right"  data-toggle="modal" data-target="#myModal${gEns.id}">
             <span class="glyphicon glyphicon-search"></span> Voir les Compostages
         </button> 
      </div>
...
<!--///////////////////////////////////////////////////////////////-->
                      <div class="modal fade" id="myModal${gEns.id}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel${gEns.id}">
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                              <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                              <h4 class="modal-title" id="myModalLabel${gEns.id}"><i class="fa fa-list-ul" aria-hidden="true"></i>&nbsp;Code compostage ${gEns.matiere.libelle} </h4>
                            </div>
                            ...
                            <div class="modal-body">
                              ...
                              <c:forEach items="${groupe.etudiants}" var="et">
                                ...
                                <c:if test="${et.code ==note.etudiant.code }">
                                  <dt><h4>${note.etudiant.prenom}&nbsp;${note.etudiant.nom}</h4></dt> 
                                  <dd><h4><span class="label label-default">${note.compostage}</span></h4></dd>
                                </c:if>  
