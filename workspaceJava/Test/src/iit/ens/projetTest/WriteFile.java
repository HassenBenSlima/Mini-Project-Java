...
b1 = (textField.getText().length()==1 && chckbxNewCheckBox.isSelected() && textField.getText().matches("[0-9]+") );
b2=textField_1.getText().length()==1 && chckbxNewCheckBox_1.isSelected() && textField_1.getText().matches("[0-9]+");
b3=textField_2.getText().length()==1 && chckbxNewCheckBox_2.isSelected() && textField_2.getText().matches("[0-9]+") ;
							...
							if(b1&!b2&!b3) {
								...
								new GZIPExample(s).compressGzipFile();
									...
									if(Integer.valueOf(textField_1.getText())<Integer.valueOf(textField_2.getText())) {
										new CipherSample(s).encrypt();
										new GZIPExample(s).compressGzipFile();
									}else if(Integer.valueOf(textField_1.getText())>Integer.valueOf(textField_2.getText())) {
										new GZIPExample(s).compressGzipFile();
									...
									if(Integer.valueOf(textField.getText())<Integer.valueOf(textField_1.getText()) 
											&& Integer.valueOf(textField_1.getText())<Integer.valueOf(textField_2.getText())) {
										new Buff(s).bufferedwriter();
										new CipherSample(s).encrypt();
										new GZIPExample(s).compressGzipFile();
										//new File(s).delete();
										...
										new Buff(s+".gz").bufferedwriter();
											...
											&& Integer.valueOf(textField.getText())<Integer.valueOf(textField_2.getText())) {
										new CipherSample(s).encrypt();
										new Buff(s).bufferedwriter();
										new GZIPExample(s).compressGzipFile();
									}else if(Integer.valueOf(textField_1.getText())>Integer.valueOf(textField.getText()) 
										...
										new CipherSample(s+".gz").encrypt();
											...
											&& Integer.valueOf(textField_2.getText())<Integer.valueOf(textField_1.getText())) {
										new Buff(s).bufferedwriter();
										new GZIPExample(s).compressGzipFile();
										new CipherSample(s+".gz").encrypt();
