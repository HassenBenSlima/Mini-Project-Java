...
/**
 * Multicast Image Sender Version: 0.1s
 * 
 * @author Jochen Luell
 *
 */
public class ImageSender {
	 ...
	 */
	/**
	 * Sends a byte array via multicast Multicast addresses are IP addresses in the
				...
				if (multicastImages) {
					...
					if (SHOW_MOUSEPOINTER) {
						...
						Polygon polygon1 = new Polygon(new int[] { mouseX, mouseX + 10, mouseX, mouseX },
								new int[] { mouseY, mouseY + 10, mouseY + 15, mouseY }, 4);

						Polygon polygon2 = new Polygon(
								new int[] { mouseX + 1, mouseX + 10 + 1, mouseX + 1, mouseX + 1 },
