...
public class Database {
	 ...
	 */
	public Database() {
		columns = new Object[] { "ID", "First_Name", "Last_Name", "Phone_Number", "Email_Address", "City", "State",
				"Date_Registered" };
		...
		try {
			...
			Statement sqlStatement = conn.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,
