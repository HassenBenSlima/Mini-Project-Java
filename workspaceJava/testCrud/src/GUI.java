...
public class GUI extends JFrame {
	 ...
	 * 
	 * @param db
	 *            the database object used to manipulate the database.
	 */
	public GUI(Database db) {
		...
		// Create a focus listener and add it to each text field to remove text when
		// clicked on
	...
	/**
	 * ActionListener implementation to listen for actions such as button clicks.
	 * 
	 * @author Casey Scarborough
	 */
	private class ListenForAction implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			if (e.getSource() == addCustomer) { // If the user clicks Add Customer, add the information into the
												// database
				// Create variables to hold information to be inserted, and get the info from
				// the text fields
				...
				// Check that the state matches the required format, if not display an error and
				// return
				...
				// Check that the date matches the required format, if not display an error and
				// return
				...
				try { // Attempt to insert the information into the database
					...
					Object[] customer = { customerID, firstName, lastName, phoneNumber, emailAddress, city, state,
							sqlDateRegistered };
				...
				try { // If the user clicked remove customer, delete from database and remove from
						// table
	...
	/**
	 * FocusListener implementation used to listen for JTextFields being focused on.
	 * 
	 * @author Casey Scarborough
	 */
	private class ListenForFocus implements FocusListener {
		// My terrible and possibly hack-ish way of implementing 'placeholders' in the
		// JTextFields.
	...
	/**
	 * ListenForMouse class that listens for mouse events on cells so that they can
	 * be updated.
	 * 
	 * @author Casey Scarborough
	 *
	 ...
	 * 
	 * @param columns
	 *            the Object array of column names.
	 * @param widths
	 *            the specified widths to set the columns to.
	 */
	 ...
	 *            the date that the user inputs in the Date Registered field.
