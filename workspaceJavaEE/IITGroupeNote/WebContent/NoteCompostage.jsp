...
<section class="content-header">
	<h1>
		 Saisie des Notes Compostage 
		<small>Aperçu</small>
	</h1>
	<ol class="breadcrumb">
		<li><a href="#"><i class="fa fa-dashboard"></i> Accueil</a></li>
		<li class="active">Saisie des Notes Compostage </li>
	</ol>
</section>
	...
	<div class="row">
		<div class="col-md-12">
              ...
              <div class="box">
                ...
                <center>
                <div>
                     <form class="form-inline" action="NoteCompostageController" method="post">
...
<c:forEach items="${groupe.groupeenseignants}" var="gEns">
       ...
       <label> <i class="fa fa-file-text" aria-hidden="true"></i>&nbsp; ${gEns.matiere.libelle}</label>
         <button type="button" class="btn btn-default btn-xs pull-right"  data-toggle="modal" data-target="#myModal${gEns.id}">
             <i class="fa fa-pencil-square-o fa-fw" aria-hidden="true"></i> Saisie des notes Compostage
         </button> 
      </div>
                          ...
                          <div class="modal-content">
                           ...
                           <script type="text/javascript" language="javascript">
                                ...
                                <table id="note${gEns.matiere.code}${groupe.code}${gEns.id}" class="table table-bordered table-striped table-hover ">
                                	...
                                	<tbody>
                                		<form class="form-inline" action="NoteCompostageController?matier=${gEns.matiere.code}" method="post">
		                              ...
		                              <c:forEach items="${groupe.etudiants}" var="et">
		                                ...
		                                <tr>
		                                 ...
		                                 <td>
                                           <input name="ex${note.id}" type="number" step="any" min="0" max="20" class="form-control" value="${note.noteexam}">
		                                </td>
