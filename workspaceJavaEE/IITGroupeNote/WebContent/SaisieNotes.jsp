	...
	<div class="row">
		<div class="col-md-12">
              ...
              <div class="box">
                ...
                <center>
                <div>
                     <form class="form-inline" action="SaisieNotesController" method="post">
...
<c:forEach items="${groupe.groupeenseignants}" var="gEns">
       ...
       <label> <i class="fa fa-file-text" aria-hidden="true"></i>&nbsp; ${gEns.matiere.libelle}</label>
         <button type="button" class="btn btn-default btn-xs pull-right"  data-toggle="modal" data-target="#myModal${gEns.id}">
             <i class="fa fa-pencil-square-o fa-fw" aria-hidden="true"></i> Saisie des notes 
         </button> 
      </div>
                        ...
                        <div class="modal-dialog" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                              ...
                              <h4 class="modal-title" id="myModalLabel${gEns.id}"><i class="fa fa-list-ul" aria-hidden="true"></i>&nbsp; Ajouter les notes ${gEns.matiere.libelle} </h4>
                            </div>
                           ...
                           <script type="text/javascript" language="javascript">
                                ...
                                <table id="note${gEns.matiere.code}${groupe.code}${gEns.id}" class="table table-bordered table-striped table-hover ">
                                	...
                                	<tbody>
                                		<form class="form-inline" action="SaisieNotesController?matier=${gEns.matiere.code}" method="post">
		                              ...
		                              <c:forEach items="${groupe.etudiants}" var="et">
		                                ...
		                                <tr>
		                                 ...
		                                 <td>
                                           <input name="pr${note.id}" type="number" step="any" min="0" max="20" class="form-control" value="${note.notepresentielle}">
		                                </td>
		                                 <td>
                                           <input name="tp${note.id}" type="number" step="any" min="0" max="20" class="form-control" value="${note.notetp}">
		                                   </td>
		                                 <td>
                                           <input name="ds${note.id}" type="number" step="any" min="0" max="20" class="form-control" value="${note.noteds}">		                                   
                                         </td>
		                                 </tr>
		                                </c:if>  
		                              </c:forEach>  
